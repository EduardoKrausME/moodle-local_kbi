...
class pie implements i_type {
    ...
    public static function get_name() {
        return get_string("pie_name", "local_kbi");
    }
    ...
    public static function get_description() {
        return get_string("pie_desc", "local_kbi");
    }
    ...
    public function edit(form $form, $koperebielement) {
        ...
        message::print_warning(get_string("pie_sql_warning", "local_kbi"));
            ...
            code_util::options($form, trim("
{
    ...
    public function preview($koperebielement) {
        ...
        return $OUTPUT->render_from_template("local_kbi/block_pie_preview", [
            ...
            "chart_pie_default" => get_config("local_kbi", "chart_pie_default"),
    ...
    public function preview_google($koperebielement) {
        ...
        return $OUTPUT->render_from_template("local_kbi/block_pie_preview_google", [
