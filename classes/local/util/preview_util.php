...
namespace local_kbi\local\util;
    ...
    public function details_block($block) {
        ...
        switch ($block->type) {
            case 'block-1':
                ...
                return $OUTPUT->render_from_template("local_kbi/blocks-preview-block-1", $data);
                break;
            case 'block-2':
                $data = [
                    'details_block_item_1' => $this->details_block_item($block->id, 1),
                ...
                return $OUTPUT->render_from_template("local_kbi/blocks-preview-block-2", $data);
                break;
            case 'block-3':
                $data = [
                    'details_block_item_1' => $this->details_block_item($block->id, 1),
                ...
                return $OUTPUT->render_from_template("local_kbi/blocks-preview-block-3", $data);
                break;
            case 'block-4':
                $data = [
                    'details_block_item_1' => $this->details_block_item($block->id, 1),
                ...
                return $OUTPUT->render_from_template("local_kbi/blocks-preview-block-4", $data);
                break;
            case 'block-12':
                $data = [
                    'details_block_item_1' => $this->details_block_item($block->id, 1),
                ...
                return $OUTPUT->render_from_template("local_kbi/blocks-preview-block-12", $data);
                break;
            case 'block-21':
                $data = [
                    'details_block_item_1' => $this->details_block_item($block->id, 1),
                ...
                return $OUTPUT->render_from_template("local_kbi/blocks-preview-block-21", $data);
                break;
            case 'block-25':
                $data = [
                    'details_block_item_1' => $this->details_block_item($block->id, 1),
                ...
                return $OUTPUT->render_from_template("local_kbi/blocks-preview-block-25", $data);
                break;
            case 'block-52':
                $data = [
                    'details_block_item_1' => $this->details_block_item($block->id, 1),
                ...
                return $OUTPUT->render_from_template("local_kbi/blocks-preview-block-52", $data);
                break;
        }
        ...
        if (isset($koperebielement->id)) {
            ...
            if (class_exists($blockclass)) {
                ...
                if (isset($USER->editing) && $USER->editing) {
                    $title = $title . button::edit(get_string("edit_report", "local_kbi"),
                ...
                if (class_exists($blockclass)) {
                    ...
                    $return .= $OUTPUT->render_from_template("local_kbi/blocks-details_block_item", $data);
                } else {
                    $data = ["title" => $title];
                    $return .= $OUTPUT->render_from_template("local_kbi/blocks-details_block_item", $data);
                }
                ...
                message::print_danger(get_string("block_not_found6", "local_kbi"));
            }
