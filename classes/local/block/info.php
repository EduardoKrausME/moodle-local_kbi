...
class info implements i_type {
    ...
    public static function get_name() {
        return get_string("info_name", "local_kbi");
    }
    ...
    public static function get_description() {
        return get_string("info_desc", "local_kbi");
    }
    ...
    public function edit(form $form, $koperebielement) {
        ...
        message::print_warning(get_string("info_sql_warning", "local_kbi"));
        ...
        if (false && $cache->has($koperebielement->id)) {
            ...
            try {
                ...
                if (AJAX_SCRIPT) {
                    ...
                    message::print_danger(get_string("info_error_sql", "local_kbi"));
                    return "";
                }
            }
