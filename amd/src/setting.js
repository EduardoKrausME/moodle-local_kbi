...
define(["jquery"], function($) {
    return {
        theme_palette : function() {
            ...
            var select_theme_palette = $("#id_s_local_kbi_theme_palette");
            ...
            function addAndStyle() {
                ...
                $("#id_s_local_kbi_theme_palette_html").append(element);
        ...
        chart_default : function() {
            $("#id_s_local_kbi_chart_pie_default").css({
                "white-space" : "nowrap",
                "font-family" : "monospace",
            });
            $("#id_s_local_kbi_chart_column_default").css({
                "white-space" : "nowrap",
                "font-family" : "monospace",
            });
            $("#id_s_local_kbi_chart_area_default").css({
                "white-space" : "nowrap",
                "font-family" : "monospace",
            });
            $("#id_s_local_kbi_chart_line_default").css({
                "white-space" : "nowrap",
                "font-family" : "monospace",
            });
        }
