...
define(["jquery", "jqueryui", "core/ajax", "core/notification"], function($, $ui, ajax, notification) {
    return {
        ...
        page_sortable : function(page_id) {
            $("#page-block-sort").sortable({
                ...
                update      : function(event, ui) {
                    ...
                    ajax.call([{
                        methodname : "local_kbi_block_sequence",
                        args       : {
                            itens : itens
                        }
        ...
        page_blocks : function(page_id) {
            ...
            var $bt_add_block = $('<span class="btn btn-primary btn-add-block">' + M.util.get_string("block_add", "local_kbi") + "</span>");
            ...
            $(".line-add").click(function() {
                ...
                ajax.call([{
                    methodname : "local_kbi_block_add",
                    args       : {
                        page_id : page_id,
                        ...
                        buttons   : [
                            {
                                ...
                                click : function() {
                                    ...
                                    ajax.call([{
                                        methodname : "local_kbi_block_delete",
                                        args       : {
                                            block_id : blockid
                                        }
                                    }])[0].then(function(data) {
