...
class maps implements i_type {
    ...
    public static function get_name() {
        return get_string("maps_name", "local_kbi");
    }
    ...
    public static function get_description() {
        return get_string("maps_desc", "local_kbi");
    }
    ...
    public function edit(form $form, $koperebielement) {
        ...
        message::print_warning(get_string("maps_sql_warning", "local_kbi"));
    ...
    public function get_chart_data($koperebielement) {
        ...
        $data = [];
        foreach ($rows as $row) {
            $dataip = local_kbi_iplookup_find_location($row["lastip"]);
            $userinfo = [
                "nb_visits" => 1,
                "lastip" => $row[0],
