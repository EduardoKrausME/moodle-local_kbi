...
$string['kbi:manage'] = 'Manage Business Intelligence';
$string['kbi:view'] = 'View Business Intelligence';
$string['l_ip'] = 'IP';
...
<pre>  SELECT c.fullname AS course_name,
         ...
         COUNT(cm.module)  AS \'lang::ca_completed_activities::local_kbi\'
...
$string['privacy:metadata:local_kbi_online'] = 'Table storing information about users currently online for analysis.';
$string['privacy:metadata:local_kbi_statistic'] = 'Table storing statistical data for analytics purposes.';
...
<ul>
    ...
    <li><b>{component}</b>: Refers to the component where the language string is defined and is typically the name of the plugin (e.g., <code>mod_forum</code>, <code>local_kdashboard</code>, <code>theme_degrade</code>).</li>
</ul>
