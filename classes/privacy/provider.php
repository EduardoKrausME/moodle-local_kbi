...
/**
 * Privacy Subsystem implementation for local_kbi.
 *
 * @package   local_kbi
...
class provider implements
    ...
    public static function get_metadata(collection $collection): collection {
        $collection->add_database_table('local_kbi_online',
            [
            ...
            'privacy:metadata:local_kbi_online'
        );
        $collection->add_database_table('local_kbi_statistic',
            [
            ...
            'privacy:metadata:local_kbi_statistic'
        );
        return $collection;
    }
    ...
    public static function get_contexts_for_userid(int $userid): \core_privacy\local\request\contextlist {
        ...
        $contextlist->add_from_sql(sprintf($sql, 'local_kbi_online'), ['userid' => $userid]);
        $contextlist->add_from_sql(sprintf($sql, 'local_kbi_statistic'), ['userid' => $userid]);
    ...
    public static function get_users_in_context(userlist $userlist) {
        ...
        $userlist->add_from_sql(sprintf($sql, 'local_kbi_online'), ['contextid' => $context->id]);
        $userlist->add_from_sql(sprintf($sql, 'local_kbi_statistic'), ['contextid' => $context->id]);
    }
    ...
    public static function delete_data_for_all_users_in_context(context $context) {
        ...
        $DB->delete_records_select('local_kbi_online', 'userid = :userid', $where);
        $DB->delete_records_select('local_kbi_statistic', 'userid = :userid', $where);
    }
