...
class area extends line {
    ...
    public static function get_name() {
        return get_string("area_name", "local_kbi");
    }
    ...
    public static function get_description() {
        return get_string("area_desc", "local_kbi");
    }
    ...
    public function preview($koperebielement) {
        ...
        return $OUTPUT->render_from_template("local_kbi/block_area_preview", [
            ...
            "chart_default" => get_config("local_kbi", "chart_area_default"),
    ...
    public function preview_google($koperebielement) {
        ...
        return $OUTPUT->render_from_template("local_kbi/block_area_preview_google", [
