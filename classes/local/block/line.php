...
class line implements i_type {
    ...
    public static function get_name() {
        return get_string("line_name", "local_kbi");
    }
    ...
    public static function get_description() {
        return get_string("line_desc", "local_kbi");
    }
    ...
    public function edit(form $form, $koperebielement) {
        ...
        $form->add_input(
            input_select::new_instance()
                ->set_title(get_string("select_report_type", "local_kbi"))
                ->set_name("element_type")
                ->set_value($koperebielement->type)
                ->set_values($values)
                ->set_description(get_string("select_report_type_desc", "local_kbi", $names)));

        message::print_warning(get_string("line_sql_warning", "local_kbi"));
            ...
            code_util::options($form, trim("
{
    ...
    public function preview($koperebielement) {
        ...
        $data = [
            ...
            "chart_line_default" => get_config("local_kbi", "chart_line_default"),
            ...
            "error_chart_renderer" => get_string("error_chart_renderer", "local_kbi"),
            "error_data_loader" => get_string("error_data_loader", "local_kbi"),
            "reload_time" => reload_util::convert($koperebielement->reload),
        ];
        return $OUTPUT->render_from_template("local_kbi/block_line_preview", $data);
    }
    ...
    public function preview_google($koperebielement) {
        ...
        return $OUTPUT->render_from_template("local_kbi/block_line_preview_google", [
