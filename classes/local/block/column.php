...
class column extends line {
    ...
    public static function get_name() {
        return get_string("column_name", "local_kbi");
    }
    ...
    public static function get_description() {
        return get_string("column_desc", "local_kbi");
    }
    ...
    public function preview($koperebielement) {
        ...
        return $OUTPUT->render_from_template("local_kbi/block_column_preview", [
            ...
            "chart_default" => get_config("local_kbi", "chart_column_default"),
    ...
    public function preview_google($koperebielement) {
        ...
        return $OUTPUT->render_from_template("local_kbi/block_columns_preview_google", [
